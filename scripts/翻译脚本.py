...
使用方法：
    ...
    示例:
    python 翻译脚本.py . 翻译结果/
    python 翻译脚本.py 作战单位/陆军单位 翻译/陆军单位
"""
...
class INITranslator:
    ...
    def _translate_single_value(self, value: str, stats: TranslationStats) -> str:
        ...
        # 处理移动类型和特殊值
        if value in TranslationLibrary.SPECIAL_VALUES:
...
def main() -> None:
    ...
    if input_dir == output_dir:
        ...
        print(f"翻译完成！翻译结果已保存到: {os.path.abspath(output_dir)}")
